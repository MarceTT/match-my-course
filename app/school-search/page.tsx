...
// Dynamic metadata: noindex filtered pages to prevent duplicate content
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  const params = await searchParams;
  const hasFilters = params.course || params.cities || params.weeksMin;
  ...
  return {
    ...
    robots: hasFilters 
      ...
      : { index: true, follow: true },   // index base page
    openGraph: {
