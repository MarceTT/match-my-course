...
type Props = {
    schoolId: string;
    seoCourses: any[]; // reemplaza `any` por un tipo específico si tienes
  };

const SchoolHome = ({ schoolId, seoCourses }: Props) => {
...
const schedule = searchParams.get("horario");
  ...
  const {
    ...
    onUpdateReservation,
    onSubmitReservation,
  } = useBooking({ schoolId: schoolId, course, weeks, schedule });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
          <div className="lg:col-span-2">
            ...
            <motion.p
              ...
              className="text-base text-gray-700 leading-relaxed mb-1 text-justify"
            >
