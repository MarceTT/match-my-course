      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[#2F343D] max-w-3xl mx-auto mb-8">
            Conoce a Lilu que eligió la escuela de inglés que más se adaptaba a
            sus requisitos, requerimientos y necesidades
          </p>
        </div>
        ...
        <div className="text-center">
          <Button
            asChild
            className="bg-[#5174fc] hover:bg-[#4257FF] text-white px-6 py-2 text-lg font-semibold rounded-md transition-colors"
          >
