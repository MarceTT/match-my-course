      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-16 sm:mt-20">
        ...
        <div className="relative mb-4">
          ...
          <div className="flex bg-white rounded-lg relative z-10 overflow-hidden">
            ...
            <div className="bg-[#ECECEC] p-3 md:p-6 flex-1">
              ...
              No te preocupes de nada, <strong>tu visa la gestionamos gratis</strong>{" "}para que no tengas que hacerlo por tu cuenta.
              </p>
            </div>
          </div>
        </div>
        <div className="relative mb-4">
          ...
          <div className="flex bg-white rounded-lg relative z-10 overflow-hidden">
            ...
            <div className="bg-[#ECECEC] p-3 md:p-6 flex-1">
              <p className="text-black font-medium leading-relaxed text-sm md:text-base">
              <strong>Analizamos tu perfil de postulación</strong>  en una reunión gratuita antes de iniciar el proceso.
              </p>
            </div>
          </div>
        </div>
        <div className="relative mb-4">
          ...
          <div className="flex bg-white rounded-lg relative z-10 overflow-hidden">
            ...
            <div className="bg-[#ECECEC] p-3 md:p-6 flex-1">
              <p className="text-black font-medium leading-relaxed text-sm md:text-base">
                <strong>Traducimos tu CV</strong>  y te entregamos una carta de empleador para facilitar la búsqueda laboral
              </p>
            </div>
          </div>
        </div>
