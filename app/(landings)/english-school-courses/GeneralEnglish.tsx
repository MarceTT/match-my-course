        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative mb-6 md:mb-1">
            ...
            <div className="w-full h-64 md:h-[300px] rounded-lg overflow-hidden shadow-md">
              <Image
                src={rewriteToCDN(
                  "https://match-my-course-final-bucket.s3.ap-southeast-2.amazonaws.com/landing-cursos/Programas+de+ingles+general+short-term.jpg"
                )}
                alt="Estudiantes en clase de inglés general short-term"
                width={1000}
                height={600}
                ...
                <Card className="bg-[#41B93B] text-white border-none">
                  <CardHeader className="pb-4 px-6 pt-6">
                    <CardTitle className="text-2xl md:text-3xl font-bold text-center md:text-left leading-tight">
                      Programa de inglés general short-term
                    </CardTitle>
                  </CardHeader>
