        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative mb-6 md:mb-1">
            ...
            <div className="w-full h-64 md:h-[300px] rounded-lg overflow-hidden shadow-md">
              <Image
                src={rewriteToCDN(
                  "https://match-my-course-final-bucket.s3.ap-southeast-2.amazonaws.com/landing-cursos/Ingles+general+%2B+lecciones+individuales.jpg"
                )}
                alt="Estudiantes en clase de inglés general + lecciones individuales"
                width={1000}
                height={600}
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed text-gray-700 text-center md:text-justify">
                        ...
                        <strong>ESL (English as a Second Language)</strong>.Por
                        las tardes, tendrás las clases personalizadas con un
                        profesor de inglés.Pueden ser 4,5,6 o 10 lecciones
                        individuales a la semana.
                      </p>
                    </div>
