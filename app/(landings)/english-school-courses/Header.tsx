...
export default function HeaderSection() {
  const bgUrl = rewriteToCDN(
    "https://match-my-course-final-bucket.s3.ap-southeast-2.amazonaws.com/Cursos+de+ingle%CC%81s+en+el+extranjero.jpg"
  );
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-white text-lg md:text-xl lg:text-2xl font-semibold leading-relaxed max-w-4xl mx-auto">
              ...
              elegir en cada una de ellas, desde inglés general a preparación de exámenes.
            </p>
          </div>
        </div>
      </div>
