    ...
    const accommodations: AccommodationOption[] = [
        {
          ...
          description: "Ideal si quieres incluir comidas y vivir con personas irlandesas para comunicarte todos los días",
          priceLevel: 3,
        },
        {
          type: "Accommodation",
          image:
            "/images/placeholder_img.svg",
          description: "Ideal si quieres independencia y vivir con otros estudiantes.",
          priceLevel: 3,
        },
        {
          type: "Residencia",
      ...
      <div className="grid gap-4">
        {accommodations.map((option, index) => (
          <div key={index} className="flex items-start gap-4">
            ...
            <div className="text-gray-600 font-medium">{"$".repeat(option.priceLevel)}</div>
          </div>
        ))}
      </div>
    </div>
