          ...
          >
            ...
            <div className="mt-4 flex flex-row gap-1 items-stretch">
              <Button
                ...
                className="flex-1 basis-0 min-w-0 bg-[#FF385C] hover:bg-[#E51D58] text-white px-2 py-0 rounded font-semibold inline-flex items-center justify-center gap-2 group transition-all text-[11px] sm:text-sm md:text-base leading-tight text-center whitespace-normal break-words"
              >
                <span className="text-center text-[11px] sm:text-sm md:text-base leading-tight whitespace-normal break-words">Continuar</span>
